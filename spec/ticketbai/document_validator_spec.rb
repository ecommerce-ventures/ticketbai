RSpec.describe 'DocumentValidator#validate' do
  include_context('with document')

  it 'should raise ArgumentError exception with a non supported validator type' do
    # Assert
    expect { Ticketbai::DocumentValidator.new(document: document, validator_type: :unsupported).validate }.to raise_error(ArgumentError)
  end
  ...
  it 'should not raise any error if the document is valid' do
    ...
    # Assert
    Ticketbai::DocumentValidator.new(document: signed_doc, validator_type: :issuance).validate
  end
  ...
  it 'should raise error if some field of the document is not valid' do
    ...
    # Assert
    validator = Ticketbai::DocumentValidator.new(document: signed_doc, validator_type: :issuance)
